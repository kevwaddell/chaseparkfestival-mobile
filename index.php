<?php get_header(); ?>	
<?php	
if ($wp_query->found_posts % 2 !== 0) {
$place_holders = 2 - ($wp_query->found_posts % 2);
}
?>
<?php if ( have_posts() ): ?>
<main id="main-content">
	...
	<?php while ( have_posts() ) : the_post(); ?>
		...
		<?php if ($place_holders > 0) { ?>
			...
			<div class="grid-item placeholder" style="background-image: url(<?php echo get_stylesheet_directory_uri().'/_/img/post-img-placeholder.png'; ?>)"></div>
			<?php } ?>	
		<?php } ?>
	</section>
	<div class="page-links bg-col-blue-dk">
		<?php wp_pagenavi(); ?>
	</div>	
<?php else: ?>
