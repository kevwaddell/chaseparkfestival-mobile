...
<div class="social-media-stats text-center mag-bot-20">
	...
	<div class="social-stat-wrap bg-col-facebook mag-bot-20">
		<i class="fa fa-facebook fa-2x bg-col-wht mag-bot-10 txt-col-facebook"></i>
	...
	<div class="social-stat-wrap bg-col-twitter">
		<i class="fa fa-twitter fa-2x bg-col-wht mag-bot-10 txt-col-twitter"></i>
