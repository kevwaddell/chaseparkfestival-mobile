...
<div class="info-panel panel-orange mag-bot-20">
	<h3 class="panel-header tk-azo-sans-uber text-center txt-col-orange mag-bot-10">Around the site</h3>
	<div class="panel-inner">
		<div class="panel-imgs-2 mag-bot-10">
