...
<div id="access-enquiries" class="info-panel panel-blue add-min-h">
	...
	<div class="panel-inner">
		...
		<a href="<?php echo get_permalink($contact_page->ID); ?>" class="enquiry-btn btn btn-default btn-block btn-lg tk-azo-sans-uber">Or use our online form</a>
	</div>
</div>