...
<div class="info-panel blue-grad with-icon">
	...
	<div class="panel-inner pad-top-20">
		...
		<a href="<?php echo get_permalink($contact_page->ID); ?>" class="enquiry-btn btn btn-default btn-block tk-azo-sans-uber">Or use our online form <i class="fa fa-chevron-right"></i></a>
	</div>
</div>
