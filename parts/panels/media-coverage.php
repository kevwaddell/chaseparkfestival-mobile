...
<div class="info-panel blue-grad with-icon">
	...
	<div class="panel-inner">
		...
		<div class="panel-left">
			...
			<ul class="list-unstyled media-list txt-col-wht">
	...
	<div class="panel-inner pad-top-10">
		...
		<a href="<?php echo get_permalink($contact_page->ID); ?>" class="enquiry-btn btn btn-default btn-block tk-azo-sans-uber">Or use our online form</a>
	</div>
</div>
